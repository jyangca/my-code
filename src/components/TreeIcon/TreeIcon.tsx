...
type TreeIconProps = IconProps & {
    isOpen: boolean
}

const MinusSquareO = ({ ...props }: IconProps) => (
...
const PlusSquareO = ({ ...props }: IconProps) => (
    <svg {...props} viewBox="64 -65 897 897">
        <g>
            <path
...
const CloseSquareO = ({ ...props }: IconProps) => (
    <svg {...props} viewBox="64 -65 897 897">
        <g>
            <path
...
const TreeIcon = ({ ...props }: TreeIconProps) => {
    ...
    if (children && isOpen) return <MinusSquareO {...props} />
    if (children) return <PlusSquareO {...props} />
    return <CloseSquareO {...props} />
}
